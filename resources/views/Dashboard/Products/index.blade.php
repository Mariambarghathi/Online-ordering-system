<x-layout>
    ...
    <div class="row g-4">
        @foreach ($products as $product)
            <div class="col-md-4">
               <div class="card shadow-sm" style="height: 340px; overflow: hidden;"> <!-- increased height slightly -->

    {{-- Image container with overlay --}}
    <div style="position: relative; height: 250px; width: 100%;">
        @if ($product->imgUrl)
            <img 
                src="{{ asset('storage/' . $product->imgUrl) }}" 
                alt="{{ $product->name }}" 
...
">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; gap: 0.5rem;">
        ...
        <div style="
            ...
            font-size: 0.7rem;
            font-weight: 400;
            color: {{ $product->isAvailable ? 'darkgreen' : '#ff8787' }};
        ">
