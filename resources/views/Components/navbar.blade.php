...
<nav class="navbar navbar-expand-lg fixed-top">
  <div class="container-fluid" style="margin-left: 2rem; margin-right: 2rem;">
    <a class="navbar-brand d-flex align-items-center" href="#">
      ...
      <span class="fw-bold storename" style="margin-left: 2rem;">Magical Crumbles</span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarMenu">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('store.registered.catalog') ? 'active' : '' }}" href="{{ route('store.registered.catalog') }}">
            Products
          </a>
        </li>
<li class="nav-item">
  <a class="nav-link {{ request()->is('store/registered/orders*') ? 'active' : '' }}" href="{{ route('store.registered.orders.index') }}">
    My Orders
  </a>
</li>
        ...
        <li class="nav-item">
          <a href="#" class="nav-link" data-bs-toggle="modal" data-bs-target="#logoutModal" onclick="event.preventDefault();">
